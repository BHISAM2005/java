/*   hacker rank question       Petya loves football very much. One day, as he was watching a football match, he was writing the players' 
...
dangerous. For example, the situation 00100110111111101 is dangerous and 11110111011101 is not. 
You are given the current situation. Determine whether it is dangerous or not*/
import java.util.*;
public class string_contain_football {
    public static void main(String[] args) {
        Scanner sc  =new Scanner(System.in);
        System.out.println("Enter the situation ");
        String s=sc.next();
        if(s.contains("0000000")||s.contains("1111111"))
            System.out.println("YES    dangerous");
        else
            System.out.println("NO      not dangerous");
    }
